...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'solicitudrequerimientos@clinicos.com.co';
    protected $gContrasena = 'Clinicos*2021';
    ...
    public function ticket_abierto($tick_id){
        ...
        $this->addCC("solicitudrequerimientos@clinicos.com.co");
        $this->addCC("");
        $this->addCC("");
        $this->addCC("");
        $this->addCC("");
        ...
        $cuerpo = "<i>".str_replace("xnroticket", $id, $cuerpo)."</i>";
