<?php
    class Usuario extends Conectar{
            ...
            if(isset($_POST["enviar"])){
                ...
                if(empty($correo) and empty($pass)){
                    ...
                    if (is_array($resultado) and count($resultado)>0){
                        ...
                        $_SESSION["primera_vez"]=$resultado["primera_vez"];
        ...
        public function update_usuario_pass_primera_vez($usu_id,$usu_pass){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="UPDATE tm_usuario
                SET
        ...
        public function enviarEmail($email, $nombre, $asunto, $cuerpo){
            ...
            $mail->Username = 'solicitudrequerimientos@clinicos.com.co'; //Modificar
            $mail->Password = 'Clinicos*2021'; //Modificar
            
            $mail->setFrom('solicitudrequerimientos@clinicos.com.co', 'Solicitud Requerimientos'); //Modificar
