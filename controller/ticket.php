<?php
    ...
    switch($_GET["op"]){
        ...
        case "insert":
            $datos=$ticket->insert_ticket($_POST["usu_id"],$_POST["cat_id"],$_POST["tick_titulo"],$_POST["tick_descrip"],$fecha,$hora,$_POST["pri_id"],$_POST["tick_cel"],$_POST["tick_anydesk"]);
        ...
        case "listar_x_usu":
            ...
            foreach($datos as $row){
                ...
                $sub_array[] = date("Y-m-d", strtotime($row["fech_crea"]))." a las ".$Hora;
                ...
                if($row["fech_cierre"]==null){
                    ...
                    $sub_array[] = date("Y-m-d", strtotime($row["fech_cierre"]))." a las ".$Hora;
                }
        ...
        case "listar":
            ...
            foreach($datos as $row){
                ...
                if($row["fech_asig"]==null){
                    ...
                    $sub_array[] = date("Y-m-d", strtotime($row["fech_asig"]))." a las ".$Hora;
                }

                if($row["fech_cierre"]==null){
                    $sub_array[] = '<span class="label label-pill label-default">Sin Cerrar</span>';
                }else{
                    $sub_array[] = date("Y-m-d", strtotime($row["fech_cierre"]));
                }
